...
const getStyles = (C: any) => StyleSheet.create({
    ...
    cardGlow1: { position: "absolute", top: -40, right: -40, width: 150, height: 150, borderRadius: 75, backgroundColor: `rgba(255,255,255,0.18)` },
    cardGlow2: { position: "absolute", bottom: -60, left: -20, width: 120, height: 120, borderRadius: 60, backgroundColor: `rgba(0,0,0,0.1)` },
